...
class OTPlanSampler:
    """OTPlanSampler implements sampling coordinates according to a squared L2 OT plan with
    ...
    def get_map(self, x0, x1):
        """
        Rturn the OT transition matrix between observations in source and target 
        """
        # Use uniform marginal probability distributions 
    ...
    def sample_trajectory(self, X):
        ...
        # Use the indexes drawn from OT probabilities for building a trajectory 
        to_return = []
