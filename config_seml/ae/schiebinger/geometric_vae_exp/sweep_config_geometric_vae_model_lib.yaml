seml:
  ...
  name: 4_OFFICIAL_sweep_lib_deep_geometric_schiebinger
...
fixed: 
  # General hparameters 
  training.task_name: 4_OFFICIAL_sweep_lib_deep_geometric_schiebinger
  training.seed: 42

  # Datamodule hyperparameters 
  datamodule.path: /nfs/homedirs/pala/scCFM/project_dir/data/schiebinger_et_al/processed/schiebinger_et_al.h5ad
  ...
  logger.project: 4_OFFICIAL_sweep_lib_deep_geometric_schiebinger
